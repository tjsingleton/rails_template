Feature: Manage User Sessions
  ...
  Scenario: When I request a password reset
    Given a user with the email "user@server.com" and password "password"
    When I request to reset my password as "user@server.com"
    Then "user@server.com" should receive an email
  ...
  Scenario: When I reset my password
    Given a user with the email "user@server.com" and password "password"
    When I reset my password as "user@server.com" to password "newpass"
    Then I should be logged in as "user@server.com"
  ...
  Scenario: On failed login my email address should be filled on the password reset page
    Given I log in as "user@server.com" and password "password"
    When I follow "Forgot your password?"
    Then the "email" field should contain "user@server.com"